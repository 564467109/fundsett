...
<div id="dlg1" class="easyui-dialog" style="width: 800px; height: 350px; padding: 10px 20px;" closed="true" buttons="#dlg-buttons1">
      ...
      <div class="fitem">
	    ...
	    <label>&nbsp;&nbsp;费用类型：</label>
	    <input id="b_feeType" class="easyui-combobox" name="b_feeType" data-options="valueField:'value',textField:'key',editable:false,url:'feetype.htm',onSelect: function(rec){    
            var va = rec.value;
            if('6' == va){
...
<!-- 	    <label>&nbsp;&nbsp;创建时间：</label> -->
<!-- 	    <input id="b_createdate" type="text" data-options="editable:false" class="easyui-datetimebox"/> -->
	    <br/><br/>
	    <label>是否有效：</label>
	    <select id="statux" class="easyui-combobox" name="statux" style="width:153px;" data-options="editable:false">
	   		<option value="0" selected="selected">是</option>
			<option value="1">否</option>
	   	</select>
	   	<label>&nbsp;&nbsp;是否显示：</label>
	   	<select id="isshow" class="easyui-combobox" name="isshow" style="width:153px;" data-options="editable:false">
	   		<option value="0" selected="selected">是</option>
			<option value="1">否</option>
	   	</select>
	</div>
